...
const FAQ_SECTIONS = [
  {
    ...
    items: [
      ...
      { q: 'What is your processing time?', a: 'Our bags are handmade to order, so processing times vary with order volume. Please allow 3–4 days for your bag to be made and prepared for delivery.' },
  ...
  },
  {
    title: 'Payment',
    items: [
      { q: 'What payment methods do you accept?', a: 'We accept MTN MoMo, Vodafone Cash, AirtelTigo Money, Visa, Mastercard (via Paystack), and bank transfer.' },
